...
from rlm.rlm_sub import RLMSub
...
class REPLEnv:
    def __init__(
        ...
        self.sub_rlm: RLM = RLMSub(model=recursive_model)
                ...
                try:
                    ...
                    if other_lines:
                        ...
                        if non_comment_lines:
                            ...
                            is_expression = (
                                    not last_line.startswith(('import ', 'from ', 'def ', 'class ', 'if ', 'for ',
                                                              'while ', 'try:', 'with ', 'return ', 'yield ', 'break',
                                                              'continue', 'pass')) and
